  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        ibm_plex_sans_thai: ["var(--font-ibm_plex_sans_thai)", ...fontFamily.sans],
        ...
        dancing_script: ["var(--font-dancing_script)", ...fontFamily.sans],
        sacramento: ["var(--font-sacramento)", ...fontFamily.sans],
        italianno: ["var(--font-italianno)", ...fontFamily.sans],
      },
      colors: {
